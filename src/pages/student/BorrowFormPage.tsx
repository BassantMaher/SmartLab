...
import { getInventoryItemById, addBorrowRequest, addNotification, updateInventoryItem } from '../../utils/localStorage';
...
const BorrowFormPage: React.FC = () => {
  ...
  useEffect(() => {
    if (itemId) {
      const inventoryItem = getInventoryItemById(itemId);
      if (inventoryItem) {
    ...
    return (
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="bg-white rounded-2xl shadow-md p-8 text-center">
          ...
          <h3 className="text-lg font-medium text-gray-800 mb-2">Item Not Found</h3>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="border-t border-gray-200 pt-4">
                <dl className="space-y-2">
                  <div className="flex justify-between">
                    ...
                    <dd className="text-sm font-medium text-gray-900">{item.availableQuantity} / {item.totalQuantity}</dd>
                  </div>
                  <div className="flex justify-between">
        ...
        <div className="lg:col-span-2">
          <div className="bg-white rounded-2xl shadow-md p-6">
            <h2 className="text-xl font-semibold text-gray-800 mb-6">Borrow Request Form</h2>
                ...
                <div className="flex items-center mb-6 bg-[#DFF5E1] p-4 rounded-lg">
                  ...
                  <div className="ml-3">
                    <p className="text-sm text-[#3B945E]">
                      By submitting this request, you agree to take responsibility for the borrowed equipment and return it by the due date.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex justify-end">
                  ...
                  <button
                    ...
                    className={`px-4 py-2 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white bg-[#3B945E] hover:bg-[#74B49B] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#3B945E] ${
                      isSubmitting || item.availableQuantity === 0 ? 'opacity-50 cursor-not-allowed' : ''
                    }`}
                  >
