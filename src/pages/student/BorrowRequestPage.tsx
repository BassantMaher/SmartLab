...
import { getInventoryItems, addBorrowRequest, addNotification } from '../../utils/localStorage';
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-1">Browse and request laboratory equipment</p>
      </div>
